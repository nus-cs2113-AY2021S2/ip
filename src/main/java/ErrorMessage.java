public class ErrorMessage {
    ...
    public static final String ERROR_MISSING_BY_KEYWORD = "OOPS!!! ☹ I'm sorry, but I don't know what that means :-(" +
            "\nYou need to use the \"by\" keyword";
    public static final String ERROR_MISSING_AT_KEYWORD = "OOPS!!! ☹ I'm sorry, but I don't know what that means :-(" +
            "\nYou need to use the \"at\" keyword";
